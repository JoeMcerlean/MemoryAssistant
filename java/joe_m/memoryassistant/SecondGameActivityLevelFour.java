...
public class SecondGameActivityLevelFour extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        AlertDialog.Builder builder1 = new AlertDialog.Builder(SecondGameActivityLevelFour.this);
        builder1.setMessage("For this game remember the first 12 words that appear.")
                .setCancelable(false)
                    ...
                    public void onClick(DialogInterface dialog, int id) {
                        ...
                        new Handler().postDelayed(new Runnable() {
                            public void run() {
                                ...
                                audio = MediaPlayer.create(SecondGameActivityLevelFour.this,songs[0]);
                                audio.start();
                            }
                        }, 2500);
                        new Handler().postDelayed(new Runnable() {
                            public void run() {
                                ...
                                audio.stop();
                                audio.release();
                                audio = MediaPlayer.create(SecondGameActivityLevelFour.this,songs[1]);
                                audio.start();
                            }
                        }, 5000);
                        new Handler().postDelayed(new Runnable() {
                            public void run() {
                                ...
                                audio.stop();
                                audio.release();
                                audio = MediaPlayer.create(SecondGameActivityLevelFour.this,songs[2]);
                                audio.start();
                            }
                        }, 7500);
                        new Handler().postDelayed(new Runnable() {
                            public void run() {
                                ...
                                audio.stop();
                                audio.release();
                                audio = MediaPlayer.create(SecondGameActivityLevelFour.this,songs[3]);
                                audio.start();
                            }
                        }, 10000);
                        new Handler().postDelayed(new Runnable() {
                            public void run() {
                                ...
                                audio.stop();
                                audio.release();
                                audio = MediaPlayer.create(SecondGameActivityLevelFour.this,songs[4]);
                                audio.start();
                            }
                        }, 12500);
                        new Handler().postDelayed(new Runnable() {
                            public void run() {
                                ...
                                audio.stop();
                                audio.release();
                                audio = MediaPlayer.create(SecondGameActivityLevelFour.this,songs[5]);
                                audio.start();
                            }
                        }, 15000);
                        new Handler().postDelayed(new Runnable() {
                            public void run() {
                                ...
                                audio.stop();
                                audio.release();
                                audio = MediaPlayer.create(SecondGameActivityLevelFour.this,songs[6]);
                                audio.start();
                            }
                        }, 17500);
                        new Handler().postDelayed(new Runnable() {
                            public void run() {
                                ...
                                audio.stop();
                                audio.release();
                                audio = MediaPlayer.create(SecondGameActivityLevelFour.this,songs[7]);
                                audio.start();
                            }
                        }, 20000);
                        new Handler().postDelayed(new Runnable() {
                            public void run() {
                                ...
                                audio.stop();
                                audio.release();
                                audio = MediaPlayer.create(SecondGameActivityLevelFour.this,songs[8]);
                                audio.start();
                            }
                        }, 22500);
                        new Handler().postDelayed(new Runnable() {
                            public void run() {
                                ...
                                audio.stop();
                                audio.release();
                                audio = MediaPlayer.create(SecondGameActivityLevelFour.this,songs[9]);
                                audio.start();
                            }
                        }, 25000);
                        new Handler().postDelayed(new Runnable() {
                            public void run() {
                                AlertDialog.Builder builder2 = new AlertDialog.Builder(SecondGameActivityLevelFour.this);
                                builder2.setMessage("Select yes or no for the next 24 words whether the word displayed was in the original 12 words.")
                                        .setCancelable(false)
                                        .setNegativeButton("Ok", new DialogInterface.OnClickListener() {
                                            @Override
                                            public void onClick(DialogInterface dialog, int id) {
                                                ...
                                                audio.stop();
                                                audio = MediaPlayer.create(SecondGameActivityLevelFour.this,testSongs[clickCount]);
                                                audio.start();
                                            }
                                        });
                                ...
                                yesButton.setOnClickListener(new View.OnClickListener() {
                                    ...
                                    public void onClick(View view) {
                                        if (clickCount < 19) {
                                            ...
                                            audio = MediaPlayer.create(SecondGameActivityLevelFour.this,testSongs[clickCount]);
                                            audio.start();
                                            AlertDialog.Builder builder = new AlertDialog.Builder(SecondGameActivityLevelFour.this);
                                            ...
                                            e.apply();
                                            Intent myIntent = new Intent(SecondGameActivityLevelFour.this, MainActivity.class);
