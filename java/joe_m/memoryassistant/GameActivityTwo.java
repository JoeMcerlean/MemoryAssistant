...
public class GameActivityTwo extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        AlertDialog.Builder builder1 = new AlertDialog.Builder(GameActivityTwo.this);
                                ...
                                btn.setOnClickListener(new View.OnClickListener() {
                                    ...
                                    public void onClick(View view) {
                                        if (amountOfFlowers < 2) {
                                            ...
                                            AlertDialog.Builder builder = new AlertDialog.Builder(GameActivityTwo.this);
                                            ...
                                            Intent myIntent = new Intent(GameActivityTwo.this, SecondGameActivityLevelTwo.class);
