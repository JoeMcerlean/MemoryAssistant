...
public class GameActivityThree extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        AlertDialog.Builder builder1 = new AlertDialog.Builder(GameActivityThree.this);
                                ...
                                btn.setOnClickListener(new View.OnClickListener() {
                                    ...
                                    public void onClick(View view) {
                                        if (amountOfFlowers < 2) {
                                            ...
                                            AlertDialog.Builder builder = new AlertDialog.Builder(GameActivityThree.this);
                                            ...
                                            Intent myIntent = new Intent(GameActivityThree.this, SecondGameActivityLevelThree.class);
