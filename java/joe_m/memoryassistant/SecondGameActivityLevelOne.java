...
public class SecondGameActivityLevelOne extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        AlertDialog.Builder builder1 = new AlertDialog.Builder(SecondGameActivityLevelOne.this);
            ...
            public void onClick(DialogInterface dialog, int id) {
                ...
                new Handler().postDelayed(new Runnable() {
                    public void run() {
                        ...
                        audio = MediaPlayer.create(SecondGameActivityLevelOne.this,songs[0]);
                        audio.start();
                    }
                }, 5000);
                new Handler().postDelayed(new Runnable() {
                    public void run() {
                        ...
                        audio.stop();
                        audio.release();
                        audio = MediaPlayer.create(SecondGameActivityLevelOne.this,songs[1]);
                        audio.start();
                    }
                }, 10000);
                new Handler().postDelayed(new Runnable() {
                    public void run() {
                        ...
                        audio.stop();
                        audio.release();
                        audio = MediaPlayer.create(SecondGameActivityLevelOne.this,songs[2]);
                        audio.start();
                    }
                }, 15000);
                new Handler().postDelayed(new Runnable() {
                    public void run() {
                        ...
                        audio.stop();
                        audio.release();
                        audio = MediaPlayer.create(SecondGameActivityLevelOne.this,songs[3]);
                        audio.start();
                    }
                }, 20000);
                new Handler().postDelayed(new Runnable() {
                    public void run() {
                        ...
                        audio.stop();
                        audio.release();
                        audio = MediaPlayer.create(SecondGameActivityLevelOne.this,songs[4]);
                        audio.start();
                    }
                }, 25000);
                new Handler().postDelayed(new Runnable() {
                    public void run() {
                        ...
                        audio.stop();
                        audio.release();
                        audio = MediaPlayer.create(SecondGameActivityLevelOne.this,songs[5]);
                        audio.start();
                    }
                }, 30000);
                new Handler().postDelayed(new Runnable() {
                    public void run() {
                        ...
                        audio.stop();
                        audio.release();
                        audio = MediaPlayer.create(SecondGameActivityLevelOne.this,songs[6]);
                        audio.start();
                    }
                }, 35000);
                new Handler().postDelayed(new Runnable() {
                    public void run() {
                        ...
                        audio.stop();
                        audio.release();
                        audio = MediaPlayer.create(SecondGameActivityLevelOne.this,songs[7]);
                        audio.start();
                    }
                }, 40000);
                new Handler().postDelayed(new Runnable() {
                    public void run() {
                        ...
                        audio.stop();
                        audio.release();
                        audio = MediaPlayer.create(SecondGameActivityLevelOne.this,songs[8]);
                        audio.start();
                    }
                }, 45000);
                new Handler().postDelayed(new Runnable() {
                    public void run() {
                        ...
                        audio.stop();
                        audio.release();
                        audio = MediaPlayer.create(SecondGameActivityLevelOne.this,songs[9]);
                        audio.start();
                    }
                }, 50000);
                new Handler().postDelayed(new Runnable() {
                    public void run() {
                        AlertDialog.Builder builder2 = new AlertDialog.Builder(SecondGameActivityLevelOne.this);
                        builder2.setMessage("Select yes or no for the next 20 words whether the word displayed was in the original 10 words.")
                            ...
                            public void onClick(DialogInterface dialog, int id) {
                                ...
                                audio.stop();
                                audio = MediaPlayer.create(SecondGameActivityLevelOne.this,testSongs[clickCount]);
                                audio.start();
                            }
                            });
                        ...
                        yesButton.setOnClickListener(new View.OnClickListener() {
                            ...
                            if (clickCount < 19) {
                                ...
                                audio = MediaPlayer.create(SecondGameActivityLevelOne.this,testSongs[clickCount]);
                                audio.start();
                                AlertDialog.Builder builder = new AlertDialog.Builder(SecondGameActivityLevelOne.this);
                                ...
                                e.apply();
                                Intent myIntent = new Intent(SecondGameActivityLevelOne.this, MainActivity.class);
