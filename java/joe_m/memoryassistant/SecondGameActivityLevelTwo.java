...
public class SecondGameActivityLevelTwo extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        AlertDialog.Builder builder1 = new AlertDialog.Builder(SecondGameActivityLevelTwo.this);
                    ...
                    public void onClick(DialogInterface dialog, int id) {
                        ...
                        new Handler().postDelayed(new Runnable() {
                            public void run() {
                                ...
                                audio = MediaPlayer.create(SecondGameActivityLevelTwo.this,songs[0]);
                                audio.start();
                            }
                        }, 4500);
                        new Handler().postDelayed(new Runnable() {
                            public void run() {
                                ...
                                audio.stop();
                                audio.release();
                                audio = MediaPlayer.create(SecondGameActivityLevelTwo.this,songs[1]);
                                audio.start();
                            }
                        }, 9000);
                        new Handler().postDelayed(new Runnable() {
                            public void run() {
                                ...
                                audio.stop();
                                audio.release();
                                audio = MediaPlayer.create(SecondGameActivityLevelTwo.this,songs[2]);
                                audio.start();
                            }
                        }, 13500);
                        new Handler().postDelayed(new Runnable() {
                            public void run() {
                                ...
                                audio.stop();
                                audio.release();
                                audio = MediaPlayer.create(SecondGameActivityLevelTwo.this,songs[3]);
                                audio.start();
                            }
                        }, 18000);
                        new Handler().postDelayed(new Runnable() {
                            public void run() {
                                ...
                                audio.stop();
                                audio.release();
                                audio = MediaPlayer.create(SecondGameActivityLevelTwo.this,songs[4]);
                                audio.start();
                            }
                        }, 22500);
                        new Handler().postDelayed(new Runnable() {
                            public void run() {
                                ...
                                audio.stop();
                                audio.release();
                                audio = MediaPlayer.create(SecondGameActivityLevelTwo.this,songs[5]);
                                audio.start();
                            }
                        }, 27000);
                        new Handler().postDelayed(new Runnable() {
                            public void run() {
                                ...
                                audio.stop();
                                audio.release();
                                audio = MediaPlayer.create(SecondGameActivityLevelTwo.this,songs[6]);
                                audio.start();
                            }
                        }, 31500);
                        new Handler().postDelayed(new Runnable() {
                            public void run() {
                                ...
                                audio.stop();
                                audio.release();
                                audio = MediaPlayer.create(SecondGameActivityLevelTwo.this,songs[7]);
                                audio.start();
                            }
                        }, 36000);
                        new Handler().postDelayed(new Runnable() {
                            public void run() {
                                ...
                                audio.stop();
                                audio.release();
                                audio = MediaPlayer.create(SecondGameActivityLevelTwo.this,songs[8]);
                                audio.start();
                            }
                        }, 40500);
                        new Handler().postDelayed(new Runnable() {
                            public void run() {
                                ...
                                audio.stop();
                                audio.release();
                                audio = MediaPlayer.create(SecondGameActivityLevelTwo.this,songs[9]);
                                audio.start();
                            }
                        }, 45000);
                        new Handler().postDelayed(new Runnable() {
                            public void run() {
                                AlertDialog.Builder builder2 = new AlertDialog.Builder(SecondGameActivityLevelTwo.this);
                                builder2.setMessage("Select yes or no for the next 20 words whether the word displayed was in the original 10 words.")
                                        ...
                                        .setNegativeButton("Ok", new DialogInterface.OnClickListener() {
                                            ...
                                            public void onClick(DialogInterface dialog, int id) {
                                                ...
                                                audio.stop();
                                                audio = MediaPlayer.create(SecondGameActivityLevelTwo.this,testSongs[clickCount]);
                                                audio.start();
                                            }
                                        });
                                ...
                                yesButton.setOnClickListener(new View.OnClickListener() {
                                    ...
                                    public void onClick(View view) {
                                        if (clickCount < 19) {
                                            ...
                                            audio = MediaPlayer.create(SecondGameActivityLevelTwo.this,testSongs[clickCount]);
                                            audio.start();
                                            AlertDialog.Builder builder = new AlertDialog.Builder(SecondGameActivityLevelTwo.this);
                                            ...
                                            e.apply();
                                            Intent myIntent = new Intent(SecondGameActivityLevelTwo.this, MainActivity.class);
