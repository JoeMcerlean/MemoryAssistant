...
public class GameActivityFour extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        AlertDialog.Builder builder1 = new AlertDialog.Builder(GameActivityFour.this);
                                ...
                                btn.setOnClickListener(new View.OnClickListener() {
                                    ...
                                    public void onClick(View view) {
                                        if (amountOfFlowers < 2) {
                                            ...
                                            AlertDialog.Builder builder = new AlertDialog.Builder(GameActivityFour.this);
                                            ...
                                            Intent myIntent = new Intent(GameActivityFour.this, SecondGameActivityLevelFour.class);
